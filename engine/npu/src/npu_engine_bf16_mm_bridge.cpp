...
extern "C" void bf16mm_set_attn_hd(int hd) { g_mm.set_attn_hd(hd); }
extern "C" void bf16mm_set_attn_nkv(int nkv) { g_mm.set_attn_nkv(nkv); }
extern "C" void bf16mm_set_attn_kv_region(uint32_t region) { g_mm.set_attn_kv_region(region); }
