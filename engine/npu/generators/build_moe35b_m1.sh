#!/bin/bash
# build_qwen3_6_35b_a3b_m1.sh — build TRUE M=1 decode xclbins for Qwen3-0.6B FFN
# (GU: K=1024,N=6144; D: K=3072,N=1024) via n1_core_i8_m1.py.
#
# The shipped final_i8_{GU,D}_qwen3_6_35b_a3b xclbins bake a fixed M=128 AIE tile
...
#
# Usage: engine/npu/generators/build_qwen3_6_35b_a3b_m1.sh
set -euo pipefail
...
build_one() {
    ...
    local xclbin="$XCLBIN_DIR/final_i8_${proj}_qwen3_6_35b_a3b_m1.xclbin"
    local insts="$XCLBIN_DIR/insts_i8_${proj}_qwen3_6_35b_a3b_m1.txt"
...
build_one MOE_GUSGU 2048 9216
build_one MOE_DSD 4608 4096
echo "OK: qwen3_6_35b_a3b M=1 xclbins built"
