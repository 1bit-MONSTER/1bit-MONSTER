...
- **Any model** — 569 architecture tokens mapping 2,036 HuggingFace arch strings; 325,462 / 325,646 text-generation checkpoints on the hub (99.94%) land on an engine token.
