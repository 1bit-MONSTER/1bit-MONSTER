...
static inline rcpp_arch_t rcpp_arch_from_string(const char* s) {
    ...
    if (strcmp(s, "attnqwen") == 0) return RCPP_ARCH_LLAMA;  // config-verified llama profile (attnqwen3)
    ...
    if (strcmp(s, "embformer") == 0) return RCPP_ARCH_LLAMA;  // config-verified llama profile (embformer)
    if (strcmp(s, "emu3") == 0) return RCPP_ARCH_LLAMA;  // config-verified llama profile (Emu3)
    ...
    if (strcmp(s, "gptx2") == 0) return RCPP_ARCH_LLAMA;  // config-verified llama profile (gptx2)
    ...
    if (strcmp(s, "rwkv6qwen2") == 0) return RCPP_ARCH_LLAMA;  // config-verified llama profile (rwkv6qwen2)
    ...
    if (strcmp(s, "visionencoderdecoder") == 0) return RCPP_ARCH_LLAMA;  // config-verified llama profile (vision-encoder-decoder)
