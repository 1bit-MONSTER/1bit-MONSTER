...
## 6. P6 — three-substrate perplexity on ONE token-id stream (quality, not fidelity)

The 53-gate suite proves fidelity-to-oracle, not text quality. This section scores the same three packs over the same 12599-id stream `[3-packs\|wikitext-2-raw slice200\|oracle tokenizer dump\|strixhalo-unknown\|12599\|wiki.test.raw slice200\|2026-09-19]`, produced once by the oracle tokenizer and consumed by every column. Tokenizer parity (our `.htok` vs the fork's `llama-tokenize`) is 24/24 whole sequences identical, so "identical stream" is demonstrated, not assumed `[3-packs\|.htok vs llama-tokenize\|tokenizer parity\|strixhalo-unknown\|-\|24 sequences\|2026-09-19]`. Full evidence, protocol, provenance and commands: `docs/research/prism-bonsai-27b/P6-three-substrate-ppl.md` and `tests/prism/ppl/`.

| pack | our engine (HIP PrismEngine), n_ctx=2048 first=1024, 6138 scored | fork oracle (Prism llama.cpp), same stream/window | ours - fork |
|---|---:|---:|---:|
| Bonsai-27B-Q1_0 | **10.9750** `[Bonsai-27B-Q1_0\|Q1_0\|HIP PrismEngine\|strixhalo-unknown\|6138\|wiki.test.raw slice200\|2026-09-19]` | 10.9992 `[Bonsai-27B-Q1_0\|Q1_0\|Prism llama.cpp fork\|strixhalo-unknown\|6138\|wiki.test.raw slice200\|2026-09-19]` | -0.024 `[Bonsai-27B-Q1_0\|Q1_0\|derived\|strixhalo-unknown\|6138\|wiki.test.raw slice200\|2026-09-19]` |
| Ternary-Bonsai-2-27B-PTQ1_0 | **8.7168** `[Ternary-Bonsai-2-27B-PTQ1_0\|PTQ1_0\|HIP PrismEngine\|strixhalo-unknown\|6138\|wiki.test.raw slice200\|2026-09-19]` | 7.5887 `[Ternary-Bonsai-2-27B-PTQ1_0\|PTQ1_0\|Prism llama.cpp fork\|strixhalo-unknown\|6138\|wiki.test.raw slice200\|2026-09-19]` | +1.128 `[Ternary-Bonsai-2-27B-PTQ1_0\|PTQ1_0\|derived\|strixhalo-unknown\|6138\|wiki.test.raw slice200\|2026-09-19]` |
| Ternary-Bonsai-27B-PQ2_0 | **9.8819** `[Ternary-Bonsai-27B-PQ2_0\|PQ2_0\|HIP PrismEngine\|strixhalo-unknown\|6138\|wiki.test.raw slice200\|2026-09-19]` | 9.8897 `[Ternary-Bonsai-27B-PQ2_0\|PQ2_0\|Prism llama.cpp fork\|strixhalo-unknown\|6138\|wiki.test.raw slice200\|2026-09-19]` | -0.008 `[Ternary-Bonsai-27B-PQ2_0\|PQ2_0\|derived\|strixhalo-unknown\|6138\|wiki.test.raw slice200\|2026-09-19]` |
...
**Finding - quality is reproduced on two of three packs, and one pack drifts.** Q1_0 and PQ2_0 reproduce the oracle's real-text quality to within 0.22% and 0.08% `[Bonsai-27B-Q1_0 + Ternary-Bonsai-27B-PQ2_0\|Q1_0 + PQ2_0\|derived\|strixhalo-unknown\|6138\|wiki.test.raw slice200\|2026-09-19]`. PTQ1_0 does not: our PPL is 14.9% higher (8.7168 vs 7.5887) `[Ternary-Bonsai-2-27B-PTQ1_0\|PTQ1_0\|HIP PrismEngine vs fork\|strixhalo-unknown\|6138\|wiki.test.raw slice200\|2026-09-19]`. The protocol is identical across the three packs, so this is pack-specific engine behavior; the mechanism was **not isolated** at the time of that measurement, and is now **resolved** (goal mu86uog3): a controlled same-stream A/B moved PTQ1_0 by 0.047% when the exact float dot replaced dp4a (8.7168 vs 8.7127), so the approximate int8 dot is **REFUTED** and the trit decode is not implicated (both A/B paths share `dot_ptq1_128`, so if the decode were at fault the exact path could not have helped) `[Ternary-Bonsai-2-27B-PTQ1_0\|PTQ1_0\|HIP PrismEngine dp4a vs exact\|strixhalo-unknown\|6138\|wiki.test.raw slice200\|2026-09-19]`. The actual cause was a **fold-group defect**: the oracle manifest (`prism.hadamard.weight_names`) folds `attn_qkv`/`attn_gate` but not `ssm_alpha`/`ssm_beta`, and our forward fed all four the rotated buffer. Fixed in `include/prism_engine.h` with dp4a **kept**; post-fix PTQ1_0 = **7.5731** vs oracle 7.5887 (−0.21%) `[Ternary-Bonsai-2-27B-PTQ1_0\|PTQ1_0\|HIP PrismEngine fold fix\|strixhalo-unknown\|6138\|wiki.test.raw slice200\|2026-09-19]`, and Q1_0 10.9750 / PQ2_0 9.8819 are byte-identical (no regression) `[Bonsai-27B-Q1_0 + Ternary-Bonsai-27B-PQ2_0\|Q1_0 + PQ2_0\|HIP PrismEngine fold fix\|strixhalo-unknown\|6138\|wiki.test.raw slice200\|2026-09-19]`. Evidence: `tests/prism/ppl/ab_exact_vs_dp4a.log`, `tests/prism/ppl/fix_full.log`. The 01:21 duplicate-runner incident stays visible in `tests/prism/ppl/our_engine_ppl.CONTAMINATED.txt`; the numbers above are the single clean 01:22:26Z run, and the runner now holds an flock so a second exits.
