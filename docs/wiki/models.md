...
every page walked) counts **411,097 text-gen checkpoints**, 325,283 with an
`architectures` field (85,814 have none). After excluding ~4,730 out-of-scope
encoder-decoders, **325,111 / 325,283 arch-bearing text-gen checkpoints
