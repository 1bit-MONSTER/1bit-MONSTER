...
`architectures` field. **302,330 / 322,029 (93.88%) map to an engine token**;
the 23 manifest families (22 validated) gate the bulk of it. Per-class counts
