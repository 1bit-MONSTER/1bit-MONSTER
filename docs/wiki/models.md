...
every page walked) counts **411,740 text-gen checkpoints**, 325,646 with an
`architectures` field (86,094 have none). After excluding ~4,730 out-of-scope
encoder-decoders, **325,462 / 325,646 arch-bearing text-gen checkpoints
