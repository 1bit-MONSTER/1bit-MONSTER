...
maps **1,946 HF `architectures` strings → 566 engine tokens** — every checkpoint
...
The **500+ models** floor is long since passed: the FULL census (2026-09-04,
every page walked) counts **405,884 text-gen checkpoints**, 326,341 with an
`architectures` field (79,543 have none). After excluding ~4,730 out-of-scope
encoder-decoders, **321,611 / 321,611 arch-bearing text-gen checkpoints
