...
- **QMoE offload**: CPU does top-K routing + token grouping; NPU executes only the SELECTED experts as batched GEMMs (not all-experts-parallel). This is exactly the #1529 'stream expert load' direction in 1bit-monster.
