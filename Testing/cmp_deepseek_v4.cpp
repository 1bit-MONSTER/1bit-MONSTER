// cmp_deepseek_v4.cpp — DeepSeek V4 engine e2e gate.
//
// Loads the mini V4 fixture (HF safetensors names), runs the 5-token prompt
...
// torch .pt reader (CPU tensor: 'torch.float32' typed storage, little-endian f32)
// minimal npy reader (float32 1-D) — same as cmp_instella
...
int main(int argc, char** argv) {
    ...
    printf("dsv4 engine top1=%d  ref top1=%d  top-%d overlap=%d/%d (need %d)\n",
